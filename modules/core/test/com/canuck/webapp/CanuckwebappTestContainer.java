...
public class CanuckwebappTestContainer extends TestContainer {

    public CanuckwebappTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/canuck/webapp/app.properties",
    ...
    public static class Common extends CanuckwebappTestContainer {

        public static final CanuckwebappTestContainer.Common INSTANCE = new CanuckwebappTestContainer.Common();
